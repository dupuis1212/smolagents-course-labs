"""Quill's cost-aware CLI (Module 4; Module 8: returns a validated QuillReport; Module 11: vision).
...
from .agent import build_quill, build_report_task, review_charts
...
def main(argv: list[str] | None = None) -> int:
    ...
    # The line below is the ONLY place the run announces what powers it.

...
Scope (06 §2, deferred to M15): the eval runs on the CURRENT ``QUILL_EXECUTOR`` (no forced remote
sandbox), and it does NOT harden Quill — that assembly is the capstone.
"""
